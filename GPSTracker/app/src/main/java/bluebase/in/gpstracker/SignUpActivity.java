...
public class SignUpActivity extends AppCompatActivity {
    ...
    String urlSignUp = CommonUtils.IP + "/GPSTracker/gps_tracker_android/signup.php";
    String urlOTPVerifier = CommonUtils.IP + "/GPSTracker/gps_tracker_android/otpVerifier.php";
